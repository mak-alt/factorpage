<main class="main-content w-full px-[var(--margin-x)] pb-8" x-data="{ general: true, seo: false, submitButtonDisabled: false, slug:'' }">
              ...
              <div class="tab-content p-4 sm:p-5" x-show="general">
                <div class="space-y-5">
                    ...
                    <x-input 
                        ...
                        class="" 
                        labelClass="font-medium text-slate-600 dark:text-navy-100"
                        x-on:keyup="slug = slug.replace(/[^a-zA-Z0-9]/g, '-').replace(/-+/g, '-').replace(/\s+/g, '-').toLowerCase()"
                    >
                    </x-input>
                  <div>
                    <span
        ...
        <div class="col-span-12 lg:col-span-4">
          ...
          <div class="card space-y-5 p-4 sm:p-5 mt-4">
            <div>
              ...
              >
              <x-filepond wire:model="form.image" name="form.image" existingFiles="" allowFileTypeValidation acceptedFileTypes="['image/png', 'image/jpg', 'image/jpeg']" allowFileSizeValidation maxFileSize="500000"  class="relative mt-1.5"></x-filepond>
            </div>
          </div>
        </div>
    </div>
