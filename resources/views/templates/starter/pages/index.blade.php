...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      {{ getTemplateOption('title') }}
    </title>
    <link
      rel="shortcut icon"
      href="{{ global_asset('templates/'.strtolower(getSelectedTemplate()->name).'/assets/images/logo/'.getTemplateOption('favicon').'') }}"
      type="image/x-icon"
    />
        ...
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="" class="navbar-logo block w-full py-5">
              <img
                src="{{ global_asset('templates/'.strtolower(getSelectedTemplate()->name).'/assets/images/logo/'.getTemplateOption('logo').'') }}"
                alt="logo"
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="{{ global_asset('templates/assets/images/hero/hero-image.jpg') }}"
                  alt="hero"
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/about/about-image-01.jpg') }}"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/about/about-image-02.jpg') }}"
                      alt="about image"
                      class="h-full w-full object-cover object-center"
                    />
                  </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  <div class="mb-[18px] flex items-center gap-[2px]">
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/testimonials/icon-star.svg') }}"
                      alt="star icon"
                    />
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/testimonials/icon-star.svg') }}"
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/testimonials/author-01.jpg') }}"
                        alt="author"
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/testimonials/author-02.jpg') }}"
                        alt="author"
                        class="h-[50px] w-[50px] overflow-hidden rounded-full"
                      />
                    </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/testimonials/author-03.jpg') }}"
                        alt="author"
                        class="h-[50px] w-[50px] overflow-hidden rounded-full"
                      />
                    </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/team/team-01.png') }}"
                  alt="team image"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="{{ global_asset('templates/https://cdn.tailgrids.com/1.0/assets/images/team/image-07/image-02.png') }}"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="{{ global_asset('templates/https://cdn.tailgrids.com/1.0/assets/images/team/image-07/image-03.png') }}"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="{{ global_asset('templates/https://cdn.tailgrids.com/1.0/assets/images/team/image-07/image-04.png') }}"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".1s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="" class="block">
                  <img
                    src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/blog/blog-01.jpg') }}"
                    alt="image"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".15s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="" class="block">
                  <img
                    src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/blog/blog-02.jpg') }}"
                    alt="image"
                    class="w-full transition group-hover:rotate-6 group-hover:scale-125"
                  />
                </a>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".2s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="" class="block">
                  <img
                    src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/blog/blog-03.jpg') }}"
                    alt="image"
                    class="w-full transition group-hover:rotate-6 group-hover:scale-125"
                  />
                </a>
    ...
    <section class="pb-20 dark:bg-dark">
      <div class="container px-4">
        ...
        >
          <a href="">
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/graygrids.svg') }}"
              alt="graygrids"
              class="dark:hidden"
            />
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/graygrids-white.svg') }}"
              alt="graygrids"
          ...
          <a href="">
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/lineicons.svg') }}"
              alt="lineicons"
              class="dark:hidden"
            />
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/lineicons-white.svg') }}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="">
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/uideck.svg') }}"
              alt="uideck"
              class="dark:hidden"
            />
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/uideck-white.svg') }}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="">
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/ayroui.svg') }}"
              alt="ayroui"
              class="dark:hidden"
            />
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/ayroui-white.svg') }}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="">
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/tailgrids.svg') }}"
              alt="tailgrids"
              class="dark:hidden"
            />
            <img
              src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/brands/tailgrids-white.svg') }}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
    ...
    >
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              >
                <img
                  src="{{ global_asset('templates/assets/images/logo/logo-white.svg') }}"
                  alt="logo"
                  class="max-w-full"
                />
              </a>
              ...
              <div class="flex flex-col gap-8">
                ...
                >
                  <div class="overflow-hidden rounded">
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/blog/blog-footer-01.jpg') }}"
                      alt="blog"
                    />
                  </div>
                  <span
                ...
                >
                  <div class="overflow-hidden rounded">
                    <img
                      src="{{ global_asset(''.strtolower(getSelectedTemplate()->name).'/assets/images/blog/blog-footer-02.jpg') }}"
                      alt="blog"
                    />
                  </div>
                  <span
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="{{ global_asset('templates/assets/images/footer/shape-1.svg') }}" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="{{ global_asset('templates/assets/images/footer/shape-3.svg') }}" alt="" />
        </span>
